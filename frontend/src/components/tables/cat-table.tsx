...
const CatTable = (): JSX.Element => {
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', width: '100%', height: '100%', rowGap: 2, mx: 2 }}>
      ...
      {(isPending || isLoading || isFetching || isRefetching || delMutation.isPending || queryCatMutation.isPending) && <CustomBackdrop isOpen={true} />}
      ...
      <TableContainer component={Paper} sx={{ flex: 1, minHeight: '30vh', maxHeight: '50vh', overflow: 'scroll' }}>
        <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table" stickyHeader>
          <TableHead >
            <TableRow>
              <TableCell scope="col" align='left' sx={{ fontWeight: 800 }}>ID</TableCell>
              <TableCell scope="col" align='left' sx={{ fontWeight: 800 }}>Nome</TableCell>
              <TableCell scope="col" align="right" sx={{ fontWeight: 800 }}>Status</TableCell>
              <TableCell scope="col" align="right" sx={{ fontWeight: 800 }}>Descrição</TableCell>
              <TableCell scope="col" align="right" sx={{ fontWeight: 800 }}>Observação</TableCell>
              <TableCell scope="col" align="right" sx={{ fontWeight: 800 }}>Criado em</TableCell>
              <TableCell scope="col" align="right" sx={{ fontWeight: 800 }}>Atualizado em</TableCell>
              <TableCell scope="col" align="right" sx={{ fontWeight: 800 }}>Ações</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {items && items.length > 0 ? items.map((item: CatProps, i: number) => (
