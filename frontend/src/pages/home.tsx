...
import logout from '../assets/images/logout-2-svgrepo-com.svg';
import { useNavigate } from "react-router-dom";
import manage from '../assets/images/manage-dates-svgrepo-com.svg';
import { useEndSession } from "../hooks/use-end-session";
import { motion } from 'framer-motion';

const MotionCard = motion(Card);

type PagePath = '/gerenciar' | '/dashboard' | '/login';
        ...
        >
            {cards.map((card) => (
                <MotionCard
                    ...
                    key={card.title}
                    sx={{ display: 'flex', flexDirection: 'column', maxWidth: 345, flexGrow: 1, flexShrink: 0, flexBasis: 0, minWidth: 300, minHeight: 300, transition: "none", cursor: 'pointer' }}
                >
                        <CardMedia
