/*
Esquema de validação de crição para uma transação
*/
...
export const createTxSchema = z
  .object({
    ...
    tdate: z.string().refine((dateString) => GeneralValidator.validateDateUntilPresent(dateString), {
    ...
    description: z.string().max(100, 'Descrição pode ter no máximo 100 caracteres'),
  })
  .strict()
