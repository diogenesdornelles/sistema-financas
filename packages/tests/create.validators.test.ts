import { createCatSchema } from '../validators/zodSchemas/create/createCatValidator';
import { createCfSchema } from '../validators/zodSchemas/create/createCfValidator';
import { createCpSchema } from '../validators/zodSchemas/create/createCpValidator';
import { createCrSchema } from '../validators/zodSchemas/create/createCrValidator';
import { createPartnerSchema } from '../validators/zodSchemas/create/createPartnerValidator';
import { createTcfSchema } from '../validators/zodSchemas/create/createTcfValidator';
import { createTcrSchema } from '../validators/zodSchemas/create/createTcrValidator';
import { createTcpSchema } from '../validators/zodSchemas/create/createTcpValidator';
import { createTxSchema } from '../validators/zodSchemas/create/createTxValidator';
import { createTokenSchema } from '../validators/zodSchemas/create/createTokenValidator';
import { createUserSchema } from '../validators/zodSchemas/create/createUserValidator';
import { createUserRepPwdSchema } from '../validators/zodSchemas/create/createUserRepPwdValidator';
